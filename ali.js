...
//             } else {
//                 console.log("Sidar ist so genervt und verlässt weinend den Zug");
//                console.log(`_____ ____\ r\ n\ / ___\ / __ ___ _ ___\ / __\\ _ _____ ____\ r\ n\ / (_\ / _ \`\/  \' \\\/ -_) \/ \/_\/ \/ |\/ \/ -_) __\/\r\n\\___\/\\_,_\/_\/_\/_\/\\__\/  \\____\/|___\/\\__\/_\/   \r\n                                          `);
...
//     let porno = ["ja", "nein"];
//     let omieShare = readlineSync.keyInSelect(porno, "Item benutzen?");
//     console.clear();
//     if (omieShare === 0) {
//         if (sidar.presents.length < 1) {
//             let noOmieShare = dices();
//             console.log(
...
// console.log(
//     "Nur ein Platz ist noch frei, bei einer alten DameEr atmet auf, wenigstens keine Freakshow mehr, es hätte ihn wahrlich schlimmer treffen können und so setzt er sich zu der Omi.  Die Omi lächelt Sidar an.“Sind Sie Kanacke Junger Mann ? Sidar verschluckt sich an seinem eigenen Speichel und fängt heftig an zu husten..\n ");

// pos4 = ["er nickt einfach und lässt das ganze über sich ergehen ", "Gute Frau, ich hatte einen sehr anstrengenden Tag und würde sehr gerne einfach nur etwas Ruhe genießen"];

// dameHaltestelle = readlineSync.keyInSelect(pos4, "soll er etwas sagen");
// console.clear();

// //Mr. Pornobalken
// if (dameHaltestelle === 0) {
//     console.log(
//         "Die Omi lächelt Sidar an. “Sind Sie Kanacke Junger Mann?”.\n");
//     console.log(
//         "Sidar verschluckt sich an seinem eigenen Speichel und fängt heftig an zu husten.");


//     console.log("Omi attake:");
//     let omioo = ["ja", "nein"];
//     let omieShare = readlineSync.keyInSelect(omioo, "Item benutzen?");
//     console.clear();
//     if (omieShare === 0) {
//         if (sidar.presents.length < 1) {

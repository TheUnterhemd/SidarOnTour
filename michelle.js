...
Sidars Freundin ist sichtlich verärgert und dies verunsichert Sidar für: ${hotDice1}.`);
  ...
  if (sidar.excitement >= 180) {
    ...
    console.log(
      `Sidar ist sichtlich irritiert und seine Aufregung steigt um ${sidar.excitement}`
    );
  }
} else if (hot === 1) {
  ...
  console.log(`
  AUTSCH!!! Sidar springt mit Anlauf in das Fettnäpfen und ist absolut angespannt. Er schluckt einmal tief und versucht durchzuatmen
